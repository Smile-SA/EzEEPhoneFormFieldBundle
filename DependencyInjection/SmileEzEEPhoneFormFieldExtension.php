...
namespace Smile\EzEEPhoneFormFieldBundle\DependencyInjection;
...
class SmileEzEEPhoneFormFieldExtension extends Extension implements PrependExtensionInterface
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $container->prependExtensionConfig('assetic', array('bundles' => array('SmileEzEEPhoneFormFieldBundle')));
